...
namespace PaintTrek
{
    class TripleFire:PlayerBullet
    {
        Bullet[] bullets;

        public TripleFire(Sprite owner) 
        {
            ...
            // this.owner = owner;
            AssignOwner(owner);
            SetCharacterInfo("Triple Player Fire", 10, 0, 10);
        }
        ...
        {
            base.Load();
            //SetTextures(Globals.Content.Load<Texture2D>("Guns/laser"));
